package mg.school.hei.endpoint.event.consumer;
...
import mg.school.hei.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("mg.school.hei.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "mg.school.hei.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }

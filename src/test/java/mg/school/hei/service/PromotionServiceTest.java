...
class PromotionServiceTest {
    ...
    void create_should_save_a_new_promotion() {
        ...
        when(promotionRepository.save(any()))
                .thenAnswer(inv -> inv.getArgument(0, JPromotion.class).toBuilder().id(UUID.randomUUID()).build());
    ...
    void delete_should_reject_an_unknown_promotion() {
        ...
        assertThatThrownBy(() -> service.delete(id)).isInstanceOf(java.util.NoSuchElementException.class);
    }
